...
interface Container {
  name: string; id: string; fileName: string | null; icon: string | null; image: string; state: string; status: string; editable: boolean; templateMatch: "name" | "file" | null;
}
